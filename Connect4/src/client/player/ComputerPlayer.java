...
public abstract class ComputerPlayer extends Player {
	...
	/**.
	 * Starts the thinking process of the <code>ComputerPlayer</code> 
	 * and returns the move the AI has determined on.
	 * @param fieldCopy is a copy of the current playing field 
	 * used by the ComputerPlayer to determine
	 * the next move.
